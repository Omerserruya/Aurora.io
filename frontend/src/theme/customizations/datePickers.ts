...
// Extend the base Components type to include DatePickers components
declare module '@mui/material/styles' {
  interface Components {
    MuiPickersPopper: any;
    MuiPickersArrowSwitcher: any;
...
type DatePickersComponents = Pick<Components<Theme>,
  | 'MuiPickersPopper'
...
export const datePickersCustomizations: DatePickersComponents = {
  MuiPickersPopper: {
    styleOverrides: {
  ...
  MuiPickersMonth: {
    styleOverrides: {
      monthButton: ({ theme }: StyleProps<any>) => ({
  ...
  MuiPickersYear: {
    styleOverrides: {
      yearButton: ({ theme }: StyleProps<any>) => ({
        fontSize: theme.typography.body1.fontSize,
        color: theme.palette.grey[600],
        padding: theme.spacing(0.5),
        borderRadius: theme.shape.borderRadius,
